      ...
      <DialogContent sx={{ width: "400px" }}>
        ...
        >
          <Typography variant="body1">
            <strong>Tên người mượn:</strong> {ticketToRead.name}
          </Typography>
          <Typography variant="body1">
            <strong>Tên sách:</strong> {ticketToRead.title}
          </Typography>
          <Typography variant="body1">
          ...
          <Typography variant="body1">
            ...
            {ticketToRead.status === true
              ? formatCurrency(
                  ticketToRead.price * ticketToRead.quantity * differenceDays
                )
              : "Chờ thanh toán"}
          </Typography>
          <Typography variant="body1">
